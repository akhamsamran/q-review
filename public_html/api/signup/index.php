...
EOF;
		...
		$swiftMessage->setFrom(["fcrawford@cnm.edu" => "fcrawford"]);
		/**
		...
		// update reply
		$reply->message = "Thank you for creating a kmaru profile. One more step before you can start playing the game, you need to verify your email address";
	} else {
